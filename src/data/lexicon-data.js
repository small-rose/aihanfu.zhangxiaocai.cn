...
const items = [
  ...
  { term: '椎髻', pinyin: 'chuí jì', detail: "（同原第3条/第7条）椎髻是中国最古老且延续时间最长的发式之一，男女通用。战国至秦汉男性普遍梳此发式。《汉书·陆贾传》载\"尉佗魋结\"（魋结即椎髻），\"今兵士椎头髻也\"，说明秦汉兵士亦梳椎髻。已录入本词库古代女子发髻部分。", meaning: '将头发盘卷成椎形垂于脑后，男女通用，最古老发髻之一', category: 'hairstyle', sub: '结椎式', dynasty: '先秦', identity: '各阶层', tags: ['汉'], imagePath: '/static/lexicon/faji/chuiji.png' },
  ...
  { term: '盘桓髻', pinyin: 'pán huán jì', detail: "盘桓髻属于盘叠式发髻中的一种。《中华古今注》载：\"长安妇女好为盘桓髻，到今其法不绝。\"其梳编法是将头发蟠曲交卷，盘叠于头顶上，造型稳定而不走落。\"盘桓\"本义为盘旋环绕，形容此髻曲卷盘旋之态。盘桓髻自晋代兴起后影响深远，唐代长安妇女仍普遍梳此发式，历数百年而不衰。", meaning: '发蟠曲交卷盘叠于头顶，稳而不落', category: 'hairstyle', sub: '盘叠式', dynasty: '晋', identity: '各阶层女性', tags: ['魏晋', '唐'], imagePath: '/static/lexicon/faji/panhuanji.png' },
  { term: '飞天髻', pinyin: 'fēi tiān jì', detail: "飞天髻是极具仙气的发式，因受佛教艺术中\"飞天\"形象的启发而得名。《宋五行志》载：\"文帝元嘉六年，民间妇人结发者三分发，抽其鬟直上，谓之飞天。\"其梳编方法是将发分成三股，各挽成小鬟耸立于头顶，状如向上飞升之势。唐代敦煌壁画中的飞天女仙多梳此发髻。在古风插画中，飞天髻是塑造仙女形象的首选发型。", meaning: '结三鬟于顶耸立直上，受佛教飞天启发', category: 'hairstyle', sub: '结鬟式', dynasty: '南北朝', identity: '民间女性', tags: ['魏晋', '唐'], imagePath: '/static/lexicon/faji/feitianji.png' },
  ...
  { term: '元宝髻', pinyin: 'yuán bǎo jì', detail: "元宝髻属于反绾式发髻的一种。其梳编法是将发拢结于顶，再用木架或假发笼蔽撑起，使发髻呈元宝形，中间高而两端略低翘。《晋书》载：\"用发既多，不可恒载，乃先木及笼上装之，曰假髻或假头。\"唐张雄夫妇合葬墓出土的女俑即有此种发型。因元宝为财富象征，此发式也暗含吉祥富贵之意。", meaning: '髻形似元宝中部隆起两端略翘', category: 'hairstyle', sub: '反绾式', dynasty: '唐', identity: '贵族女性', tags: ['唐', '宋'], imagePath: '/static/lexicon/faji/yuanbaoji.png' },
  ...
  { term: '同心髻', pinyin: 'tóng xīn jì', detail: "同心髻与朝天髻类似但更为简单朴素。梳时将头发全部向上梳至头顶部位，挽成一个圆形的发髻，以簪固定。其形圆润饱满，\"同心\"之名寓意夫妻同心，故已婚女子尤其喜欢此发式。北宋时期流行广泛，上至贵妇下至平民皆可见。", meaning: '发向上梳至头顶挽成圆形发髻', category: 'hairstyle', sub: '结椎式', dynasty: '宋', identity: '各阶层女性', tags: ['宋'], imagePath: '/static/lexicon/faji/tongxinji.png' },
  { term: '高椎髻', pinyin: 'gāo zhuī jì', detail: "高椎髻属于结椎式发髻的一种。《妆台记》载：\"宋理宗朝宫妃梳高髻于顶，巍峨高耸，号高椎髻。\"其梳编法是将头发全部拢结于头顶，挽成一个高耸的椎形发髻，形似倒置的椎体，耸立于头顶。在宋代山西太原晋祠女塑中可见此发式。明代贵妇亦沿用此式。", meaning: '发拢结于顶挽成单椎耸立头顶', category: 'hairstyle', sub: '结椎式', dynasty: '宋', identity: '宫妃', tags: ['宋', '明'], imagePath: '/static/lexicon/faji/gaozhuiji.png' },
  { term: '包髻', pinyin: 'bāo jì', detail: "包髻是在发髻梳成之后，用纱、罗、绢、缯等色帛将发髻包裹起来的发式。此风始于宋代，金元时期成为礼服的一部分，至明代发展成重要的头饰形式——䯼髻。《宋史·舆服志》记载，宫中后妃亦常以包髻为饰。包裹发髻的织物颜色和质地因身份而异，贵者用锦罗，平常人家用素绢，既实用（防止发髻松散）又具装饰性。明代的䯼髻即渊源于此。", meaning: '发髻梳成后用绢帛包裹', category: 'hairstyle', sub: '通用', dynasty: '宋', identity: '各阶层女性', tags: ['宋', '明'], imagePath: '/static/lexicon/faji/baoji.png' },
  { term: '流苏髻', pinyin: 'liú sū jì', detail: "流苏髻是同心髻的一种装饰性变体。在梳成同心髻后，于发髻根部系扎彩色丝带，使丝带自然垂下如流苏般摇曳，故名。此发式兼具清雅与装饰之美，在宋代仕女画中有描绘。", meaning: '同心髻根部系扎丝带垂下如流苏', category: 'hairstyle', sub: '结椎式', dynasty: '宋', identity: '各阶层女性', tags: ['宋'], imagePath: '/static/lexicon/faji/liusuji.png' },
  ...
  { term: '双螺髻', pinyin: 'shuāng luó jì', detail: "双螺髻在明代江南地区极为流行，其形类似春秋战国时期的螺髻，时称\"把子\"。梳编时将头发分为两大股，各盘成螺壳状，分置头顶两侧。螺髻清晰秀雅，简便大方，是江南女子尤其是丫环侍女喜爱的发式。", meaning: '双螺形发髻江南称把子，未婚女子常见', category: 'hairstyle', sub: '盘叠式', dynasty: '明', identity: '未婚女子', tags: ['明'], imagePath: '/static/lexicon/faji/shuangluoji.png' },
  ...
  { term: '垂挂髻', pinyin: 'chuí guà jì', meaning: '发顶平分两大股梳成对称环髻垂挂两侧', category: 'hairstyle', sub: '双挂式', dynasty: '通用', identity: '未婚少女', tags: [], detail: '垂挂髻是双挂式发髻的一种，将发顶平分两大股梳结成环状髻垂于两侧。唐代《纨扇仕女图》中可见此发式。', imagePath: '/static/lexicon/faji/chuiguaji.png' },
  { term: '双平髻', pinyin: 'shuāng píng jì', meaning: '发顶平分两大股梳成对称髻平垂挂两侧', category: 'hairstyle', sub: '双挂式', dynasty: '通用', identity: '侍女少女', tags: [], detail: '双平髻是双挂式的典型形式，将发顶平分两大股梳结成对称髻平垂挂于两侧。敦煌壁画中大量出现。', imagePath: '/static/lexicon/faji/shuangpingji.png' },
  ...
  { term: '凌云髻', pinyin: 'líng yún jì', detail: "凌云髻属于结鬟式中的高式单鬟。《中华古今注》载：\"始皇诏后梳凌云髻，三妃梳望仙九鬟髻，九嫔梳参鸾髻。\"也就是说早在秦始皇时期，皇后就开始梳凌云髻。其形态如凌云高耸、巍峨瞻望，在历代仕女画与神女造像中皆可见。", meaning: '高式单鬟如凌云之姿', category: 'hairstyle', sub: '结鬟式', dynasty: '秦', identity: '后妃', tags: ['汉', '唐'], imagePath: '/static/lexicon/faji/lingyunji.png' },
  { term: '百合髻', pinyin: 'bǎi hé jì', meaning: '髻形如百合花绽放', category: 'hairstyle', sub: '盘叠式', dynasty: '唐', identity: '贵族女性', tags: ['唐'], detail: '百合髻是唐代流行的一种发髻，髻形如百合花层层绽放。唐代壁画与仕女画中多见。', imagePath: '/static/lexicon/faji/baiheji.png' },
  // -- 男性发式 --
