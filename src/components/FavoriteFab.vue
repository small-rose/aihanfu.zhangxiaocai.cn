      ...
      <view class="fd-body">
        ...
        <template v-else-if="detailItem.type === 'lexicon'">
          <view class="fd-lexicon-body">
            ...
            <view class="fd-lexicon-right" v-if="detailItem.imagePath || detailItem.hex">
              ...
              <view v-else class="fd-lexicon-hex-swatch" :style="{ backgroundColor: detailItem.hex }">
...
.fd-palette-left { width: 100px; flex-shrink: 0; text-align: right; }
.fd-palette-right { width: 100px; flex-shrink: 0; }
...
@media (max-width: 768px) {
  .fab-btn { width: 40px; height: 40px; bottom: 24px; right: 12px; font-size: 20px; }
  .fab-badge { font-size: 9px; min-width: 16px; height: 16px; }
